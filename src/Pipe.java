...
/**
 * Describe general behavior of a pipe, it contain its position and can give the coordinates of the two direction you can connect to
 * @author simon
 *
 */
public class Pipe{
...
public String toString(){
	return "Position: "+posPipeY+","+posPipeX+"\nTo "+posIPipeY+","+posIPipeX+" and "+posOPipeY+","+posOPipeX;
}
}
